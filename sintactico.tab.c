...
static const yytype_int16 yyrline[] =
{
      ...
      85,    90,    95,   109,   112,   115,   128,   130,   164,   183,
     215,   217,   220,   222,   227,   252,   280,   307,   335,   348,
     361,   374,   387,   397,   399,   409
};
#endif
...
{
  "$end", "error", "$undefined", "VOID", "VAR", "READ", "PRINT", "CONST",
  "IF", "ELSE", "WHILE", "LPAREN", "RPAREN", "SEMICOLON", "COMMA",
  "ASSIGNOP", "LCOR", "RCOR", "PLUSOP", "MINUSOP", "POR", "BARRAOP",
  "UMINUS", "STRING", "ID", "INTLITERAL", "$accept", "program", "$@1",
  "declarations", "$@2", "$@3", "identifier_list", "asig",
...
{
     -33,     4,     3,   -33,   -14,     6,     7,    33,   -33,    46,
     -33,   -33,    -3,    11,    11,    27,    19,    75,    76,   -33,
     -33,    73,   -33,    74,    63,   -33,    65,   -33,    67,    21,
      21,   -33,   -33,   -33,    69,   -33,    45,    21,    21,    10,
      21,    21,   -33,    11,   -33,   -33,    66,    36,   -33,   -33,
      19,    21,    21,    21,    21,    40,    50,   -33,    54,    45,
     -33,   -33,   -33,   -33,    64,    64,   -33,   -33,    23,    23,
     -33,    82,   -33,    23,   -33
};
...
static const yytype_int8 yydefact[] =
{
       ...
       3,     0,    13,    11,     0,     9,     0,    26,     0,     0,
       0,    25,    34,    35,     0,    22,    24,     0,     0,     0,
       0,     0,     5,     0,     7,    21,     0,     0,    32,    20,
       0,     0,     0,     0,     0,     0,     0,    16,     0,    12,
      10,    27,    33,    23,    28,    29,    30,    31,     0,     0,
      15,    18,    19,     0,    17
};
...
{
      47,    48,    15,    16,     3,    17,     4,    18,    55,    56,
       5,    58,    59,    19,    20,    15,    16,     6,    17,     7,
      18,    21,    64,    65,    66,    67,    19,    57,    15,    16,
      29,    17,    29,    18,    21,    23,    71,    72,    30,    19,
      30,    74,    31,    32,    33,    32,    33,    21,    62,     8,
      10,    27,    68,    11,    51,    52,    53,    54,    51,    52,
      53,    54,    69,    51,    52,    53,    54,    70,    51,    52,
      53,    54,    51,    52,    53,    54,    42,    43,    44,    43,
      45,    46,    49,    50,    53,    54,    37,    38,    40,    41,
      61,    73,    26,    63,    60,     0,    39
};

static const yytype_int8 yycheck[] =
{
      29,    30,     5,     6,     0,     8,     3,    10,    37,    38,
      24,    40,    41,    16,    17,     5,     6,    11,     8,    12,
      10,    24,    51,    52,    53,    54,    16,    17,     5,     6,
      11,     8,    11,    10,    24,    24,    68,    69,    19,    16,
      19,    73,    23,    24,    25,    24,    25,    24,    12,    16,
       4,    24,    12,     7,    18,    19,    20,    21,    18,    19,
      20,    21,    12,    18,    19,    20,    21,    13,    18,    19,
      20,    21,    18,    19,    20,    21,    13,    14,    13,    14,
      13,    14,    13,    14,    20,    21,    11,    11,    15,    15,
      24,     9,    14,    50,    43,    -1,    19
};
...
{
       0,    27,    28,     0,     3,    24,    11,    12,    16,    29,
       4,     7,    34,    30,    31,     5,     6,     8,    10,    16,
      17,    24,    35,    24,    32,    33,    32,    24,    38,    11,
      19,    23,    24,    25,    36,    37,    39,    11,    11,    34,
      15,    15,    13,    14,    13,    13,    14,    39,    39,    13,
      14,    18,    19,    20,    21,    39,    39,    17,    39,    39,
      33,    24,    12,    37,    39,    39,    39,    39,    12,    12,
      13,    35,    35,     9,    35
};
...
#line 90 "sintactico.y"
                                                                                                                                {if (!perteneceTablaS((yyvsp[0].cadena))) nuevaEntrada((yyvsp[0].cadena), tipo);
...
#line 95 "sintactico.y"
                                                                                                                {if (!perteneceTablaS((yyvsp[-2].cadena))) nuevaEntrada((yyvsp[-2].cadena), tipo);
																	else{ printf("Linea %d: Variable %s ya declarada \n", yylineno, (yyvsp[-2].cadena)); errores_semanticos++;}
...
#line 115 "sintactico.y"
                                                                                        {if (!perteneceTablaS((yyvsp[-3].cadena))){ printf("Linea %d: Variable %s no declarada \n", yylineno, (yyvsp[-3].cadena)); errores_semanticos++;}
																	else if (esConstante((yyvsp[-3].cadena))){ printf("Linea %d: Asignacion a constante \n", yylineno); errores_semanticos++;}
...
#line 215 "sintactico.y"
                                                                                                        {(yyval.codigo)=(yyvsp[-1].codigo);}
#line 1643 "sintactico.tab.c"
    break;

  case 21:
#line 217 "sintactico.y"
                                                                                                                {(yyval.codigo)=(yyvsp[-1].codigo);}
#line 1649 "sintactico.tab.c"
    break;
